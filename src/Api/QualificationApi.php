...
class QualificationApi
{
     ...
     * @param  string $lc_src Language source (optional)
     * @param  string $lc_tgt Language target (optional)
     * @param  int $preferred_by Preferred worker by a customer ID (optional)
     * @param  string $sort_by Columns to sort. &#39;-&#39; for descending; &#39;+&#39; for ascending (optional)
     ...
     * @return \QualificationClient\Model\QualificationResponse[]
     */
    public function getQualifications($qualification_type, $id = null, $worker_id = null, $status = null, $rank = null, $lc_src = null, $lc_tgt = null, $preferred_by = null, $sort_by = null, $page = null, $limit = null)
    {
        list($response) = $this->getQualificationsWithHttpInfo($qualification_type, $id, $worker_id, $status, $rank, $lc_src, $lc_tgt, $preferred_by, $sort_by, $page, $limit);
        return $response;
    }
     ...
     * @return array of \QualificationClient\Model\QualificationResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getQualificationsWithHttpInfo($qualification_type, $id = null, $worker_id = null, $status = null, $rank = null, $lc_src = null, $lc_tgt = null, $preferred_by = null, $sort_by = null, $page = null, $limit = null)
    {
        $returnType = '\QualificationClient\Model\QualificationResponse[]';
        $request = $this->getQualificationsRequest($qualification_type, $id, $worker_id, $status, $rank, $lc_src, $lc_tgt, $preferred_by, $sort_by, $page, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getQualificationsAsync($qualification_type, $id = null, $worker_id = null, $status = null, $rank = null, $lc_src = null, $lc_tgt = null, $preferred_by = null, $sort_by = null, $page = null, $limit = null)
    {
        return $this->getQualificationsAsyncWithHttpInfo($qualification_type, $id, $worker_id, $status, $rank, $lc_src, $lc_tgt, $preferred_by, $sort_by, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getQualificationsAsyncWithHttpInfo($qualification_type, $id = null, $worker_id = null, $status = null, $rank = null, $lc_src = null, $lc_tgt = null, $preferred_by = null, $sort_by = null, $page = null, $limit = null)
    {
        $returnType = '\QualificationClient\Model\QualificationResponse[]';
        $request = $this->getQualificationsRequest($qualification_type, $id, $worker_id, $status, $rank, $lc_src, $lc_tgt, $preferred_by, $sort_by, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getQualificationsRequest($qualification_type, $id = null, $worker_id = null, $status = null, $rank = null, $lc_src = null, $lc_tgt = null, $preferred_by = null, $sort_by = null, $page = null, $limit = null)
    {
        // verify the required parameter 'qualification_type' is set
        if ($qualification_type === null || (is_array($qualification_type) && count($qualification_type) === 0)) {
            throw new \InvalidArgumentException(
